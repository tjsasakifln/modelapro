...
| **A03** prova de norma e de incapacidade | `BLOCKED_ON_C01` | `handoff_c01_grade_not_met.md` — repro determinístico | Grau pedido destrói o resultado em vez de rotulá-lo `not_met`. Fora da propriedade de escrita de C06 |
